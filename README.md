# JSSSTU Web Technology Lab

**1.** Design a web page for the department timetable containing a suitable header, footer, description of the course codes and titles, faculty name and initialises, etc., use `href`, list tags and add University logo as a background. Using `table` tag and additional features like spanning rows, columns and table borders. _[Refer: A sample class timetable]_
