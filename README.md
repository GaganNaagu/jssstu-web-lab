...
**[Refer: A sample class timetable]**
...
Write HTML code to develop a webpage having two frames that divide the webpage into two equal rows and then divide the row into equal columns.
...
**a)** Validate date in dd-mm-yyyy format.
